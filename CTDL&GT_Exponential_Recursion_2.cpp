nguồn tham khảo: https://freetuts.net/de-quy-da-tuyen-exponential-recursion-2958.html
//bài toán tìm tất cả các dãy nhị phân có chiều dài n nhập từ bàn phím.//
#include<stdio.h>
#include<iostream>
using namespace std;
